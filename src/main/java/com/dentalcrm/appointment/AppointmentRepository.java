...
public interface AppointmentRepository extends JpaRepository<Appointment,Long>{
 ...
 List<Appointment> findByDoctorIdAndStartTimeGreaterThanEqualAndStartTimeLessThanOrderByStartTime(Long doctorId,OffsetDateTime from,OffsetDateTime to);
 List<Appointment> findByStartTimeGreaterThanEqualAndStartTimeLessThanOrderByStartTime(OffsetDateTime from,OffsetDateTime to);
 List<Appointment> findByStatusOrderByStartTimeDesc(AppointmentStatus status);
 List<Appointment> findByStatusInAndEndTimeAfter(Collection<AppointmentStatus> statuses, OffsetDateTime moment);
