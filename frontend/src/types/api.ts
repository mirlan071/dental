...
export interface DebtorSummary {
  ...
  doctors: DebtorDoctor[];
}
export interface DebtAppointment {
...
export interface DoctorDashboardSummary {
  ...
  revenue: number;
  averageCheck: number;
  payments: { cash: number; card: number; qr: number };
}
